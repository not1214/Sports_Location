<div class="container">
  <div class="row">
    ...
    <div class="col-md-7">
      ...
      @elseif($target == 'edit')
      <form action="{{ route('events.reviews.update', ['event'=>$event->id, 'review'=>$review->id]) }}" method="post">
        @method('patch')
      @endif
        @csrf
        <div class="row mb-3">
        ...
        <div class="row mb-3">
          ...
          <div class="col-10 offset-1 col-md-11 offset-md-0 mt-1">
            <textarea id="comment" name="comment" class="form-control">{{ old('comment', $review->comment) }}</textarea>
          </div>
        </div>
        ...
        <div class="row justify-content-center mb-1">
          ...
          @elseif($target == 'edit')
          <button type="submit" class="col-8 col-md-3 mb-2 mb-md-0 btn btn-primary">編集する</button>
          @endif
        </div>
      </form>
